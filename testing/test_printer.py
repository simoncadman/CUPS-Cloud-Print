...
def test_getListDescription():
    global printers
    assert printers[0].getListDescription() == "Save to Google Drive - " + \
        Utils.PROTOCOL + "testaccount2%40gmail.com/__test_save_docs - testaccount2@gmail.com"
    assert printers[1].getListDescription() == "Save to Google Drive 2 DisplayName - " + \
        Utils.PROTOCOL + "testaccount2%40gmail.com/__test_save_docs_2 - testaccount2@gmail.com"
...
def test_getCUPSBackendDescription():
    global printers
    assert printers[0].getCUPSBackendDescription() == 'network ' + Utils.PROTOCOL + \
        ...
        Utils.PROTOCOL + 'testaccount2%40gmail.com/__test_save_docs"'
    assert printers[1].getCUPSBackendDescription() == 'network ' + Utils.PROTOCOL + \
        ...
        Utils.PROTOCOL + 'testaccount2%40gmail.com/__test_save_docs_2"'
    printers[0]._fields['tags'] = ['novalue', 'name=value', 'location=test-location']
    assert printers[0].getCUPSBackendDescription() == 'network ' + Utils.PROTOCOL + 'testaccount2%40gmail.com/__test_save_docs "Save to Google Drive" "Save to Google Drive @ test-location" "MFG:Google;DRV:GCP;CMD:POSTSCRIPT;DES:GoogleCloudPrint;MDL:' + \
        Utils.PROTOCOL + 'testaccount2%40gmail.com/__test_save_docs" "test-location"'
...
def test_getPPDName():
    global printers
    assert printers[
        0].getPPDName() == "cupscloudprint:testaccount2%40gmail.com:__test_save_docs.ppd"
    assert printers[
        1].getPPDName() == "cupscloudprint:testaccount2%40gmail.com:__test_save_docs_2.ppd"
...
def test_getOverrideCapabilities():
    ...
    assert printerItem._getOverrideCapabilities(
        "test=one anothertest=two") == {'test': 'one', 'anothertest': 'two'}
    assert printerItem._getOverrideCapabilities(
        "test=one anothertest=two Orientation=yes") == {'test': 'one', 'anothertest': 'two'}
