...
Requires:       cups,ghostscript,system-config-printer-libs,python-httplib2,/usr/bin/pdf90,/usr/bin/pdf270,/usr/bin/pdflatex,/usr/share/texlive/texmf-dist/tex/generic/oberdiek/ifluatex.sty,/usr/share/texmf-dist/web2c/fmtutil.cnf,/usr/share/texlive/texmf/texconfig/tcfmgr,/usr/share/texlive/texmf-dist/tex/latex/pdftex-def/pdftex.def
